...
/**
 * Servlet implementation class colArt
 */
@WebServlet("/colArt")
public class colArt extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if("collection".equals(action)){
			...
			ArtcolVO artcolVO = artSrc.addCol(mem_id, art_id);
			ArticleVO artVO = artSrc.findByArt_id(art_id);
			request.setAttribute("artcolVO", artcolVO);
